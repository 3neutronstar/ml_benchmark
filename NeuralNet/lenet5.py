...
class LeNet5(nn.Module):
    def __init__(self, config):
        ...
        self.b_size_list = [6, 16, 400, 84, config['num_classes']]
        self.NN_size_list = [1, 6, 16, 400, 84, config['num_classes']]  # cnn과 fc_net out 작성
        self.model_list = ['cnn', 'cnn', 'fc', 'fc', 'fc']
        self.kernel_size_list = [(5, 5), (5, 5)]
        self.node_size_list=[6,16,400,84,config['num_classes']]
