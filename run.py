...
TRAIN_MODE=['train','train_weight_prune', 'train_grad_visual', 'train_lrp','train_mtl','train_mtl_v2','train_mtl_v3','train_mtl_v4']
def parse_args(args):
...
def main(args):
    ...
    if flags.mode == 'train' or flags.mode=='train_weight_prune':
        ...
        configs=learner.run()
        save_params(configs, time_data)
    elif flags.mode=='train_mtl_v2' or flags.mode=='train_mtl_v4':
